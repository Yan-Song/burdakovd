...
urlpatterns = patterns('',
                       ...
                       url(r'^activation/successful/$',
                           direct_to_template,
                           {'template': 'registration/registration_activation_successful.html'},
                           name='registration_activation_successful'),
                       url(r'^activation/failed/$',
                           direct_to_template,
                           {'template': 'registration/registration_activation_failed.html'},
